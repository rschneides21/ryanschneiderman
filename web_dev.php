	...
	<body>
      ...
      <div id = "content">
        <div id = "design">
          ...
          <p class = "design-descr">I see myself as a developer first and a designer second. But in many ways, the two are intertwined and the principles that make for good code are much the same as those that make for good design. The first principle of design I view as important is minimalism. Simple code is good code. Code should be self explanatory and easily readible. Elegant code should always be pursued over complex. Likewise in good design. At its core, design is a form of communication and as in any form of communication, a clear message is important. Design is much like an essay or a speech; a thesis or core message is essential. The rest of a design must clearly support the core message. Everything from color, to font, to arrangement of elements should evoke in the viewer a feeling which aligns with the core message. Anything else serves only to distract. For example, the thesis in the photography website below is simply to showcase the photographs. Every design choice was made with the photographs in mind. Specifically, I chose an aesthetic with little color or embellishing features, and a simple and symmetrical font so as to not draw the eye of the viewer away from the images.</p>
